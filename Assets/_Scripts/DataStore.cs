...
public class DataStore : MonoBehaviour{
    ...
    public static void Save()
    {
        ...
        FileStream file = File.Create(Application.persistentDataPath + "/playerInfo32.dat");
    ...
    {
        if(File.Exists(Application.persistentDataPath + "/playerInfo32.dat"))
        {
            BinaryFormatter bf = new BinaryFormatter();
            FileStream file = File.Open(Application.persistentDataPath + "/playerInfo32.dat", FileMode.Open);
