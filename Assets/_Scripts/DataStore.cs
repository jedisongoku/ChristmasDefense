...
public class DataStore : MonoBehaviour{
    ...
    public static void Save()
    {
        ...
        FileStream file = File.Create(Application.persistentDataPath + "/playerInfo33.dat");
    ...
    {
        if(File.Exists(Application.persistentDataPath + "/playerInfo33.dat"))
        {
            BinaryFormatter bf = new BinaryFormatter();
            FileStream file = File.Open(Application.persistentDataPath + "/playerInfo33.dat", FileMode.Open);
