...
public class DataStore : MonoBehaviour{
    ...
    public static void Save()
    {
        ...
        FileStream file = File.Create(Application.persistentDataPath + "/playerInfo20.dat");
    ...
    {
        if(File.Exists(Application.persistentDataPath + "/playerInfo20.dat"))
        {
            BinaryFormatter bf = new BinaryFormatter();
            FileStream file = File.Open(Application.persistentDataPath + "/playerInfo20.dat", FileMode.Open);
