...
public class DataStore : MonoBehaviour{
    ...
    public static void Save()
    {
        ...
        FileStream file = File.Create(Application.persistentDataPath + "/playerInfo29.dat");
    ...
    {
        if(File.Exists(Application.persistentDataPath + "/playerInfo29.dat"))
        {
            BinaryFormatter bf = new BinaryFormatter();
            FileStream file = File.Open(Application.persistentDataPath + "/playerInfo29.dat", FileMode.Open);
        ...
        else
        {
            ...
            for(int i = 2; i <= 12; i++)
            {
                Player.completedLevels.Add(i, 0); //change back to -1
