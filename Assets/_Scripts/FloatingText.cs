...
public class FloatingText : MonoBehaviour
{
	...
	void OnEnable()
    {
        ...
        Vector3 lookPosition = new Vector3(transform.position.x, GameManager.gameManager.cameraLocation.position.y, GameManager.gameManager.cameraLocation.position.z - 20);
