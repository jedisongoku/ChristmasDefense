...
public class Level11 : Level {
    ...
    public List<Transform> destination_1_7 = new List<Transform>();
    ...
    public List<Transform> destination_2_7 = new List<Transform>();
    public List<Transform> destination_2_8 = new List<Transform>();
    ...
    void OnEnable()
    {
        ...
        path_2.Add(destination_2_7);
        path_2.Add(destination_2_8);
